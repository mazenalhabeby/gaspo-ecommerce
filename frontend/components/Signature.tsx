  ...
  return (
    <div ref={ref} className="flex justify-center items-center w-28">
      ...
      >
        ...
        />
        <motion.path
          d="M89.14,36.18c-1.8,1.8-1.5,4,.6,3.6.9-.2,1.8-1.3,2-2.6.4-2.4-.7-2.9-2.6-1Z"
          stroke="black"
          strokeWidth={1.5}
          fill="black"
          custom={1}
          variants={pathVariants}
        />
        {/* add more path sections if needed */}
      </motion.svg>
    </div>
  )
}
